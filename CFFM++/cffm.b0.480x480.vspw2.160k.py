...
model = dict(
    ...
    pretrained='/root/autodl-tmp/VSS-CFFM/pretrained/mit_b0_converted.pth',
...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/cffm_b0_baseline/latest.pth'
workflow = [('train', 1)]
...
evaluation = dict(interval=320000, metric='mIoU', efficient_test=True)
work_dir = './work_dirs/cffm_b0_baseline'
gpu_ids = range(0, 1)
