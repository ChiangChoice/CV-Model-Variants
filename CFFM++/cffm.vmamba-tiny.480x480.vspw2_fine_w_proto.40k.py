...
log_level = 'INFO'
load_from = 'work_dirs/cffm_VMamba_baseline/iter_156000.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = './work_dirs/cffm_VMamba_plus'
out = './work_dirs/cffm_VMamba_plus/test_results.pkl'
gpu_ids = range(0, 1)
